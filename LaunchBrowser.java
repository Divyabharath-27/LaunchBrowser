...
public static void main(String[] args) {
    ...
    driver.findElement(By.id("createLeadForm_lastNameLocal")).sendKeys("bharath");
    ...
    driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("rdivyabharath@gmail.com");
